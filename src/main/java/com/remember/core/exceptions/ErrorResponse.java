...
/**
 * thanks to
 * https://github.com/FRESH-TUNA/2020-6rinkers/blob/dev/back/cocktailpick-api/src/main/java/com/cocktailpick/api/common/dto/ErrorResponse.java
 */
...
//    }
    ...
    public static class FieldError {
        ...
        private static List<FieldError> of(BindingResult bindingResult) {
            ...
            bindingResult.getGlobalErrors().forEach(e -> errors.add(new FieldError(
                    e.getObjectName(),
                    "",
                    e.getDefaultMessage()
            )));
